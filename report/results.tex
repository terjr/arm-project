...
\subsection{Performance counter}
...
number of the tested instruction, the last 2 is \textt{subs} and \textt{jne} as
...
such as our baseline instruction \textt{setend}, we see that the amount of No
