...
\IEEEPARstart{P}{rocessors} grow more sophisticated every day.

\todo[inline]{
    At the same time, processors grow more and more sophisticated. Even modern RISC
        architectures gets stuffed with features speeding up execution in return for
        added complexity and nondeterminism.

        Add something about the need for energy modeling techniques. Ideally, we
        could just feed our results to an algorithm that schedules for energy
        ...
        Energy awareness at the microarchitecture level has gotten researchers
        attention for quite some time, but as the architecture has become more
        nondeterministic it is necessary to to real world simulations and gather
        the statistics.
}
